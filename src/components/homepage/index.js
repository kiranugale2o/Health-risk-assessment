  ...
  return (
    <>
      ...
      >
        ...
        <footer>
          <div class="absolute top-[1100px] w-full mx-auto lg:w-[522px] h-[29px] lg:static lg:mt-[50px] font-exo-2 font-semibold text-2xl leading-7 text-center text-white">
